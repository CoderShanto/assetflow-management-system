        ...
        <main style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", padding:"40px 32px", minWidth:0 }}>
          <div className="form-card" style={{ width:"100%", maxWidth:540 }}>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:24, fontSize:12, color:T.muted }}>
              ...
              <span>›</span>
              <span style={{ color:T.text }}>Add New</span>
            </div>
            ...
            <div style={{ background:T.surface, borderRadius:20, border:`1px solid ${T.border}`, overflow:"hidden" }}>
              ...
              <div style={{ padding:"24px 28px 20px", borderBottom:`1px solid ${T.border}`, background:"linear-gradient(135deg,rgba(124,58,237,0.08) 0%,rgba(99,102,241,0.04) 100%)" }}>
                <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                  <div style={{ width:42, height:42, borderRadius:12, background:"linear-gradient(135deg,#7c3aed,#6366f1)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:20, boxShadow:"0 4px 16px rgba(124,58,237,0.35)" }}>◆</div>
                  <div>
                    <h2 style={{ fontSize:20, fontWeight:800, color:T.text, letterSpacing:"-0.3px" }}>Add Product</h2>
                    <p style={{ fontSize:12, color:T.muted, marginTop:2 }}>Register a new asset in the system</p>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} style={{ padding:28 }}>
                <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
                  ...
                  <InputField label="Warranty" name="warranty" value={formData.warranty} onChange={handleChange} placeholder="e.g. 2 Years, Until 2026-12-31" required />
                  ...
                  <div style={{ display:"flex", gap:12, marginTop:4 }}>
                    ...
                    <button type="submit" disabled={submitting}
                      style={{ flex:2, padding:"13px", borderRadius:12, background:submitting?"rgba(124,58,237,0.4)":"linear-gradient(135deg,#7c3aed,#6366f1)", border:"none", color:"#fff", fontSize:14, fontWeight:700, cursor:submitting?"not-allowed":"pointer", fontFamily:"'Sora',sans-serif", boxShadow:submitting?"none":"0 4px 20px rgba(124,58,237,0.35)", transition:"all 0.2s" }}
                    >{submitting ? "Saving…" : "Save Product →"}</button>
                  </div>
                </div>
              </form>
            </div>
